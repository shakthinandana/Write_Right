...
|Docs: doco generated , format not ugly |in GH| https://github.com/shakthinandana/Write_Right/tree/main/docs
...
| evidence that the whole team is using the same tools (e.g. tutor can ask anyone to share screen, they demonstrate the system running on their computer)| | Everyone has a local instance of the latest version of the project. The output can be shown by anyone in the team.
