...
| evidence that the members of the team are working across multiple places in the code base| 3|  We have different branches in the code repository to make changes whenever a team member works on any area of the code. The commit history in each branch is evidence for this.|
|short release cycles | 3| https://github.com/shakthinandana/Write_Right/graphs/contributors
| Online Sustainability evaluation |  |  | 
| Question 1.1: Does your website and documentation provide a clear, high-level overview of your software?| 3| Evidence is the readme.md file : https://github.com/shakthinandana/Write_Right#readme|
| Question 1.2: Does your website and documentation clearly describe the type of user who should use your software? |  3|  Evidence is the readme.md file : https://github.com/shakthinandana/Write_Right#readme|
| Question 1.3: Do you publish case studies to show how your software has been used by yourself and others? |  0| We haven't done a case study yet.|
...
| Question 10.3: Are releases tagged in the repository? |  3|  Yes, releases are tagged. Evidence : https://github.com/shakthinandana/Write_Right/releases|
